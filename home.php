...
<style>
    .logo {
        border-radius: 50%;
        height: 1.5em; /* Match the font size of VITC */
		width:1.5em;
        margin-right: 10px; /* Adjust as needed for spacing */
    }
	header {
        background-color: navy !important; /* Change this to the desired navy blue color */
        padding: 15px 0; /* Adjust padding as needed */
    }

    /* Navbar styles */
    .navbar-light .navbar-toggler-icon {
        background-color: #fff !important; /* Change this to the desired color for the toggler icon */
    }
    ...
    .navbar-nav .nav-item.active .nav-link {
        color: #fff !important; /* Change this to the desired color for active links */
    }
...
<header>
	<div class="container agile-banner_nav">
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			...
			<h1><a class="navbar-brand" href="home.php"><img src="web_home/images/LOGO.png" alt="Logo" class="logo">VITC <span class="display"></span></a></h1>
...
<footer class="py-5">
	<div class="container py-md-5">
		<div class="footer-logo mb-5 text-center">
			<a class="navbar-brand" href="https://chennai.vit.ac.in/" target="_blank">VIT <span class="display"> CHENNAI</span></a>
		</div>
